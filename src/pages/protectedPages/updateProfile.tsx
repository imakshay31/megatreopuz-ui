...
import { type } from "os";
import { useSuccessNotification, useErrorNotification, useCustomNotification } from "../../components/App/useNotification"
import Loader from "../../components/App/Loader";
import LinearLoader from "../../components/App/LinearLoader";
import { makeResolvable, ResolvablePromise } from "../../components/resolvablePromise";
...
const Profile: NextPage<ProtectedPageProps> = ({ viewer, refetch, ...props }) => {
